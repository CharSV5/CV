...
|---|---|---|---|
| [Chitter Challenge](https://github.com/CharSV5/chitter-challenge.git)  | 1 Weekend | Built a full stack Twitter clone using Ruby and Postgres | Ruby, RSpec, Sinatra, HTML, CSS, PostgreSQL |
...
I also studied Screenwriting for a couple of years and was involved in some amatuer projects. I try to use my creativity in designing my apps and problem solving.
